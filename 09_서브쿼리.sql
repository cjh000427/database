...
-- 이유: WHERE절부터 먼저 실행하고 나서 ROWNUM이 SELECT 되기 때문.
-- 해결: ROWNUM까지 붙여 놓고 다시 한 번 자료를 SELECT 해서 범위를 지정해야 됩니다.
...
/*
1. 가장 안쪽 SELECT 절에서 필요한 테이블 형식(인라인 뷰)를 생성.
