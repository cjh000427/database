...
-- pk 추가
ALTER TABLE dept2 ADD CONSTRAINT dept_mo_pk PRIMARY KEY(dept_no);
-- fk 추가
...
-- 제약 조건 삭제 (제약 조건 이름으로)
ALTER TABLE dept2 DROP CONSTRAINT dept_mo_pk;
...
CREATE TABLE members(
    ...
    gender VARCHAR2(1),
    loca NUMBER(4), -- CONSTRAINT mem_loca_loc_locid_fk REFERENCES locations(location_id)도 가능
